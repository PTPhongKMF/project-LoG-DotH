...
public class B_RollLeft_Behaviour : StateMachineBehaviour {
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        Vector3 leftDirection = -playerLocomotionController.playerMovementController.transform.right;

        playerLocomotionController.playerMovementController.characterController.Move(
            leftDirection * adjustedSpeed * Time.deltaTime
        );
    }
} 