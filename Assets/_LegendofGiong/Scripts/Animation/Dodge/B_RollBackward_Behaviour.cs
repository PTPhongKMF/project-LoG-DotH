...
public class B_RollBackward_Behaviour : StateMachineBehaviour {
    ...
    override public void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        ...
        Vector3 backwardDirection = -playerLocomotionController.playerMovementController.transform.forward;

        playerLocomotionController.playerMovementController.characterController.Move(
            backwardDirection * adjustedSpeed * Time.deltaTime
        );
    }
} 